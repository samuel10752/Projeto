...
#fr2_img_6= PhotoImage(file="imagens\\venda.png")
#fr2_img_6= PhotoImage(file="imagens\\moeda e investir.png")
...
fr2_bt1 = Button(fr2, bd=0, image=fr2_img_2,command=lambda: [fr2.grid_remove(),fr3.place()]).place(width=223, height=60, x=675, y=32)
fr2_bt2 = Button(fr2, bd=0, image=fr2_img_3).place(width=223, height=60, x=54, y=32)
fr2_bt3 = Button(fr2, bd=0, image=fr2_img_4).place(width=223, height=60, x=367, y=32)
...
# frame 3
# Criação de labels 
fr3_lab = Label(fr3,bd=0, image=fr3_img_1).place(width=310, height=470, x=970, y=130)
