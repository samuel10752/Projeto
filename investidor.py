...
#fr3_img_3= PhotoImage(file="imagens\\venda.png")
...
fr2_bt1 = Button(fr2, bd=0, image=fr2_img_2, command= lambda: [fr2.grid_forget,fr3_img_3.place_info()]).place(width=223, height=60, x=675, y=32)
